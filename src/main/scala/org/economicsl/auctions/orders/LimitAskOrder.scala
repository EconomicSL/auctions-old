...
sealed trait LimitAskOrder extends AskOrder with LimitPrice {
  this: Quantity =>

}


trait MultiUnitLimitAskOrder extends LimitAskOrder with MultiUnit {
  type O <: MultiUnitLimitAskOrder
}
