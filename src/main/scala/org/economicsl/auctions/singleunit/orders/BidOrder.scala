...
case class LimitBidOrder(issuer: UUID, limit: Price, tradable: Tradable) extends BidOrder


case class MarketBidOrder(issuer: UUID, tradable: Tradable) extends BidOrder {
